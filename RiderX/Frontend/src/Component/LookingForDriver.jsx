...
const LookingForDriver = ({ setlookingForDriverPanelUp, fare, pickUp, destination, SelectedVehicle, setwaitingforDriver, lookingForDriverPanelUp }) => {
 
  return (
    <div>
      <h2 onClick={() => {
        setlookingForDriverPanelUp(false)
      }} className='text-center -mt-2 -mb-3'><i className="ri-arrow-down-wide-line text-4xl font-extralight text-gray-300"></i></h2>


      <h2 className='text-xl font-bold ml-3 mt-2 mb-4 '>Looking For Nearby Driver</h2>
      <div className='flex flex-col w-full  justify-center items-center'>
        ...
        <div className='flex gap-3 justify-start w-full ml-7 -mt-3 mb-9 pb-3 pr-3 border-b-1 border-b-gray-400 '>
          ...
          <div>
            <p className='text-base font-medium capitalize '>{pickUp}</p>
          </div>
        </div>
